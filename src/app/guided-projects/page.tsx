...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Build a system to analyze website traffic, user behavior, and conversion funnels",
    difficulty: "Intermediate",
    duration: "120 minutes",
    skills: ["Complex Data Structures", "SQL JOINs", "Funnel Analysis"],
    buildWhat: "Traffic analytics tool with conversion rates, bounce analysis, and user journey tracking",
  },
  {
    id: 7,
    title: "Predictive Sales Forecasting",
    description: "Build a forecasting system that predicts future sales based on historical trends",
    difficulty: "Advanced",
    duration: "2-3 hours",
    skills: ["Time Series", "Trend Analysis", "Statistical Methods", "Predictions"],
    buildWhat: "Sales forecasting model with trend lines, seasonality detection, and future predictions",
  },
  {
    id: 8,
    title: "Multi-Source BI Dashboard",
    description: "Combine data from multiple sources (SQL, CSV, APIs) into one comprehensive business intelligence dashboard",
    difficulty: "Advanced",
    duration: "3-4 hours",
    skills: ["Data Integration", "Multiple Data Sources", "Complex Queries", "Dashboard Building"],
    buildWhat: "Full BI dashboard pulling from databases, files, and APIs with automated refreshing",
  },
  {
    id: 9,
    title: "Automated Reporting System",
    description: "Build a system that automatically generates and emails weekly/monthly analytics reports",
    difficulty: "Advanced",
    duration: "3-4 hours",
    skills: ["Automation", "Report Generation", "Scheduling", "Advanced Analytics"],
    buildWhat: "Automated reporting system that runs on schedule and generates formatted reports",
  },
];
