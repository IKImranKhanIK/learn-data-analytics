...
const codeLessons: CodeLesson[] = [
  ...
  },
  {
    ...
    description: "Store multiple values and use powerful list functions",
    language: "python",
    difficulty: "Beginner",
  },
  {
    id: 4,
    title: "Loops - Automate Everything",
    description: "Process hundreds of data points with just a few lines of code",
    language: "python",
    difficulty: "Beginner",
  },
  {
    ...
    description: "Make decisions in your code based on data values",
    language: "python",
    difficulty: "Beginner",
  },
  {
  ...
  },
  {
    ...
    description: "Find specific records in your database",
    language: "sql",
    difficulty: "Beginner",
  },
  {
    ...
    description: "Order results and get top/bottom records",
    language: "sql",
    difficulty: "Beginner",
  },
  {
    ...
    description: "Calculate SUM, AVG, COUNT, and GROUP BY",
    language: "sql",
    difficulty: "Intermediate",
  },
];
